...
<html>
    ...
    <body>
        ...
        <div id="show-encargado" class="content scaffold-show" role="main">
            ...
            <f:display bean="encargado" />
            <g:form resource="${this.encargado}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.encargado}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
