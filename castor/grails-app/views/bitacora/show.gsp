...
<html>
    ...
    <body>
        ...
        <div id="show-bitacora" class="content scaffold-show" role="main">
            ...
            <f:display bean="bitacora" />
            <g:form resource="${this.bitacora}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.bitacora}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
